...
<head>
    ...
    <title>500 — Server Error | BOSS KOPI</title>
...
<div class="error-card">
    ...
    <div class="error-title mt-2 mb-2">Terjadi Kesalahan Server</div>
    <p class="text-muted small mb-4">Maaf, terjadi kesalahan teknis. Tim kami sudah mendapat laporan ini. Coba kembali beberapa saat lagi.</p>
