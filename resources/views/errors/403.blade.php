...
<head>
    ...
    <title>403 — Akses Ditolak | BOSS KOPI</title>
...
<div class="error-card">
    ...
    <div class="error-title mt-2 mb-2">Akses Ditolak</div>
    <p class="text-muted small mb-4">Anda tidak memiliki izin untuk mengakses halaman ini. Silakan login dengan akun yang sesuai.</p>
