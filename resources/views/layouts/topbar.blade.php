<div class="topbar">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            <h6 class="mb-0 fw-600" style="color:var(--gold);">@yield('page-title', 'BOSS KOPI')</h6>
    ...
    <div class="d-flex align-items-center gap-3">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                @if(auth()->user()->role === 'pembeli')
                <li><a class="dropdown-item" href="{{ route('pembeli.profil') }}"><i class="fa fa-user me-2"></i>Profil Saya</a></li>
                <li><hr class="dropdown-divider"></li>
                @elseif(auth()->user()->role === 'driver')
                <li><a class="dropdown-item" href="{{ route('driver.profil') }}"><i class="fa fa-user me-2"></i>Profil Saya</a></li>
                <li><hr class="dropdown-divider"></li>
                @endif
                <li>
...
{{-- Banner Kedai Tutup --}}
@php $sedangTutup = \App\Models\Pengaturan::get('sedang_tutup', '0'); @endphp
@if($sedangTutup === '1')
...
async function cekNotifikasiPesanan() {
    try {
        const res = await fetch('{{ route("pembeli.notifikasi") }}');
        ...
        data.pesanan.forEach(p => {
            ...
            html += `<a href="{{ url('/menu-online/tracking') }}/${p.id}" class="dropdown-item py-2 border-bottom ${berubah ? 'bg-warning bg-opacity-10' : ''}">
