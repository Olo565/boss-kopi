<div class="sidebar" id="sidebar">
    ...
    <div class="px-3 py-2 border-bottom border-white border-opacity-10">
        <div class="d-flex align-items-center gap-2 py-1">
            ...
            <div>
                <div style="color:#fff;font-size:0.8rem;font-weight:600;"><?php echo e(auth()->user()->name); ?></div>
    ...
    <nav class="py-2">
        <?php if(auth()->user()->role === 'admin'): ?>
            ...
            <a href="<?php echo e(route('admin.order.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.order.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.pengaturan.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.pengaturan.*') ? 'active' : ''); ?>">
                <i class="fa fa-gear"></i> Pengaturan
            </a>

            <div class="sidebar-section-title">Manajemen</div>
            <a href="<?php echo e(route('admin.menu.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.menu.*') ? 'active' : ''); ?>">
                <i class="fa fa-utensils"></i> Menu & Produk
            </a>
            <a href="<?php echo e(route('admin.stok.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.stok.*') ? 'active' : ''); ?>">
            ...
            <?php $jumlahDriverMenunggu = \App\Models\User::where('role','driver')->where('status_akun','menunggu')->count(); ?>
            <?php if($jumlahDriverMenunggu > 0): ?>
            <a href="<?php echo e(route('admin.user.driver-menunggu')); ?>" class="nav-link" style="color:#dc3545;">
                <i class="bi bi-person-exclamation"></i> Driver Menunggu
                <span class="badge bg-danger ms-1"><?php echo e($jumlahDriverMenunggu); ?></span>
            </a>
            <?php endif; ?>
            <a href="<?php echo e(route('admin.promo.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.promo.*') ? 'active' : ''); ?>">
                <i class="fa fa-tags"></i> Promo & Diskon
            </a>

            <div class="sidebar-section-title">Laporan</div>
            <a href="<?php echo e(route('admin.laporan.penjualan')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.laporan.penjualan*') ? 'active' : ''); ?>">
                <i class="bi bi-graph-up-arrow"></i> Laporan Penjualan
            </a>
            <a href="<?php echo e(route('admin.laporan.stok')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.laporan.stok') ? 'active' : ''); ?>">
                <i class="bi bi-clipboard-data"></i> Laporan Stok
            </a>
            <a href="<?php echo e(route('admin.laporan.kasir')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.laporan.kasir') ? 'active' : ''); ?>">
                <i class="bi bi-person-check"></i> Kinerja Kasir
            </a>

            <div class="sidebar-section-title">Akses Cepat</div>
            <a href="<?php echo e(route('kasir.pos')); ?>" class="nav-link">
                <i class="bi bi-cart3"></i> Buka POS Kasir
            </a>

        <?php elseif(auth()->user()->role === 'kasir'): ?>
            <div class="sidebar-section-title">Kasir</div>
            <a href="<?php echo e(route('kasir.pos')); ?>" class="nav-link <?php echo e(request()->routeIs('kasir.pos') ? 'active' : ''); ?>">
                <i class="bi bi-cart3"></i> POS Transaksi
            </a>
            <a href="<?php echo e(route('kasir.riwayat')); ?>" class="nav-link <?php echo e(request()->routeIs('kasir.riwayat') ? 'active' : ''); ?>">
                <i class="bi bi-clock-history"></i> Riwayat Hari Ini
            </a>

            <div class="sidebar-section-title">Shift</div>
            <a href="<?php echo e(route('kasir.shift.buka')); ?>" class="nav-link <?php echo e(request()->routeIs('kasir.shift.buka') ? 'active' : ''); ?>">
                <i class="bi bi-door-open"></i> Buka Shift
            </a>
            <a href="<?php echo e(route('kasir.shift.tutup')); ?>" class="nav-link <?php echo e(request()->routeIs('kasir.shift.tutup') ? 'active' : ''); ?>">
                <i class="bi bi-door-closed"></i> Tutup Shift
            </a>

        <?php elseif(auth()->user()->role === 'pembeli'): ?>
            <div class="sidebar-section-title">Pesan</div>
            <a href="<?php echo e(route('pembeli.home')); ?>" class="nav-link <?php echo e(request()->routeIs('pembeli.home') ? 'active' : ''); ?>">
                <i class="bi bi-house"></i> Beranda
            </a>
            <a href="<?php echo e(route('pembeli.menu')); ?>" class="nav-link <?php echo e(request()->routeIs('pembeli.menu*') ? 'active' : ''); ?>">
                <i class="fa fa-mug-hot"></i> Menu
            </a>
            <a href="<?php echo e(route('pembeli.keranjang')); ?>" class="nav-link <?php echo e(request()->routeIs('pembeli.keranjang') ? 'active' : ''); ?>">
                <i class="bi bi-bag"></i> Keranjang
            </a>

            <div class="sidebar-section-title">Akun</div>
            <a href="<?php echo e(route('pembeli.riwayat')); ?>" class="nav-link <?php echo e(request()->routeIs('pembeli.riwayat') ? 'active' : ''); ?>">
                <i class="bi bi-clock-history"></i> Riwayat Pesanan
            </a>
            <a href="<?php echo e(route('pembeli.profil')); ?>" class="nav-link <?php echo e(request()->routeIs('pembeli.profil') ? 'active' : ''); ?>">
                <i class="bi bi-person-circle"></i> Profil Saya
            </a>
            <?php if(auth()->user()->role === 'pembeli' && !auth()->user()->no_hp_terverifikasi): ?>
            <a href="<?php echo e(route('verifikasi-wa.show')); ?>" class="nav-link" style="color:#dc3545;">
                <i class="bi bi-whatsapp"></i> Verifikasi WA
                <span class="badge bg-danger ms-1">!</span>
            </a>
            <?php endif; ?>
            <a href="<?php echo e(route('pengaduan.index')); ?>" class="nav-link <?php echo e(request()->routeIs('pengaduan.*') ? 'active' : ''); ?>">
                <i class="bi bi-megaphone"></i> Pengaduan Saya
            </a>
            <div class="nav-link" style="cursor:default;">
                <i class="bi bi-star"></i>
                <span>Poin: <strong style="color:var(--latte);"><?php echo e(auth()->user()->poin_loyalitas); ?></strong></span>
            </div>
        ...
        <?php elseif(auth()->user()->role === 'driver'): ?>
            ...
            <a href="<?php echo e(route('driver.orders')); ?>" class="nav-link <?php echo e(request()->routeIs('driver.orders') ? 'active' : ''); ?>">
                <i class="bi bi-bicycle"></i> Pesanan Masuk
            </a>
            <a href="<?php echo e(route('driver.riwayat')); ?>" class="nav-link <?php echo e(request()->routeIs('driver.riwayat') ? 'active' : ''); ?>">
                <i class="bi bi-clock-history"></i> Riwayat Antar
            </a>
            <a href="<?php echo e(route('driver.profil')); ?>" class="nav-link <?php echo e(request()->routeIs('driver.profil') ? 'active' : ''); ?>">
...
<?php /**PATH C:\laragon\www\boss-kopi\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>