...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'BOSS KOPI'); ?></title>
...
async function cekNotifikasi() {
    try {
        const res = await fetch('<?php echo e(route("admin.notifikasi")); ?>');
...
function tampilToast(pesan, tipe) {
    ...
    toast.style.cssText = `
        ...
        max-width: 280px;
    `;
    toast.innerHTML = `${pesan} <a href="<?php echo e(route('admin.order.index')); ?>" style="color:#E6D5C3;margin-left:8px;">Lihat →</a>`;
...
<?php /**PATH C:\laragon\www\boss-kopi\resources\views/layouts/app.blade.php ENDPATH**/ ?>