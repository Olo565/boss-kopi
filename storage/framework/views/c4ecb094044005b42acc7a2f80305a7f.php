...
<head>
    ...
    <title><?php echo e(isset($mode) && $mode === 'register' ? 'Daftar Akun' : 'Masuk'); ?> — BOSS KOPI</title>
...
<div class="auth-card">
    ...
    <div class="auth-body">
        ...
        <div class="tab-switcher">
            <button class="tab-btn <?php echo e(!isset($mode) || $mode !== 'register' ? 'active' : ''); ?>"
        ...
        <!-- FORM LOGIN -->
        <div id="formLogin" style="<?php echo e(isset($mode) && $mode === 'register' ? 'display:none' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('lupa-password.form')); ?>" style="font-size:0.78rem;color:#9c7c5e;text-decoration:none;">
                        Lupa kata sandi?
                    </a>
                </div>
        ...
        <!-- FORM REGISTER -->
        <div id="formRegister" style="<?php echo e(!isset($mode) || $mode !== 'register' ? 'display:none' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>"
                            rows="2" placeholder="Jalan, No. Rumah, Kelurahan, Kecamatan..."><?php echo e(old('alamat')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="fieldDriver" class="mb-3" style="display:none;">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="jenis_kendaraan" class="form-control <?php $__errorArgs = ['jenis_kendaraan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            value="<?php echo e(old('jenis_kendaraan')); ?>">
...
<?php /**PATH C:\laragon\www\boss-kopi\resources\views/auth/login.blade.php ENDPATH**/ ?>